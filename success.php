                    ...
                    <div class="as-searchnav-placeholder" style="height: 77px;">
                        <div class="row as-search-navbar" id="as-search-navbar" style="width: auto;">
                            <div class="as-accessories-filter-tile column large-6 small-3">
                                ...
                                <div style="text-align: center;padding-top: 5%;"><h2>PAGO EXITOSO</h2> </div>
                                <p><strong>Collection id: </strong><?php echo $_GET['collection_id'];?></p>
                                <p><strong>Collection Status: </strong><?php echo $_GET['collection_status'];?></p>
                                <p><strong>External Reference: </strong><?php echo $_GET['external_reference'];?></p>
                                <p><strong>Payment Type: </strong><?php echo $_GET['payment_type'];?></p>
                                <p><strong>Merchant Order id: </strong><?php echo $_GET['merchant_order_id'];?></p>
                                <p><strong>Preference id: </strong><?php echo $_GET['preference_id'];?></p>
